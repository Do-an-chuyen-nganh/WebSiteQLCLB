                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Quản lý các khoản chi</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Thêm khoản chi</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                                        ...
                                        <div>
                                            ...
                                            <section>
                                                <div class="form-group row">
                                                    <label class="col-lg-2 control-label " for="clbName">Tên khoản chi *</label>
                                                    <div class="col-lg-10">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-2 control-label " for="quantity">Số tièn chi</label>
                                                    <div class="col-lg-10">
