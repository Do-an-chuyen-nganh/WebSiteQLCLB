...
<div class="slimscroll-menu">
    ...
    <div id="sidebar-menu">
        ...
        <ul class="metismenu" id="side-menu">
            ...
            <li>
                <a href="listAdmin.php" class="waves-effect waves-light">
            ...
            <li>
                ...
                <ul class="nav-second-level" aria-expanded="false">
                    <li><a href="listMembers.php">Quản lý thành viên</a></li>
                    <li><a href="acceptStudent.php">Quản lý sinh viên</a></li>
                </ul>
            </li>

            <li>
                <a href="eventCLB.php" class="waves-effect waves-light">
            ...
            ?>
            <li>
                <a href="Newslist.php" class="waves-effect waves-light">
                    <i class="fa fa-calendar"></i>
                    <span>Tin Tức</span>
                </a>
            </li>
            ...
            <li>
                ...
                <ul class="nav-second-level" aria-expanded="false">
                    <li><a href="memberScoreForm.php">Thêm phiếu diểm</a></li>
                    <li><a href="listMemberScore.php">Danh sách điểm </a></li>
                </ul>
            </li>
            <li>
                
            <li>
                <a href="listSinhHoat.php" class="waves-effect waves-light">
                <i class="mdi mdi-layers"></i>
                    <span>Quản lý Sinh hoạt CLB</span>
                
                </a>
            </li>
            <li>
                <a href="finance.php" class="waves-effect waves-light">
                <i class="fas fa-funnel-dollar"></i>
                    <span>Quản lý Quỹ CLB</span>
